...
export default function NavBar() {
  return (
    <nav className=" h-20 left-14 md:left-20 fixed bg-white dark:bg-[#111827]  z-50 top-0 right-0 grid grid-cols-12 shadow border-b border-black/15 px-4 gap-4">
      <div className="flex items-center justify-between flex-1 col-span-7">
        <h1 className=" font-semibold tracking-tight">Dashboard</h1>
        <div className="hidden md:flex items-center rounded-full border dark:border-white/30 border-black/15 px-5 py-2 relative ">
          <input
            type="text"
            placeholder="Search..."
            className=" ml-5  dark:bg-transparent outline-none border-none"
          />
          <Image
            src={SearchIcon}
            width={15}
      ...
      <div className=" flex-1 flex  justify-end items-center gap-5 col-span-5">
        <div className="lg:flex items-center flex-1 hidden">
          <div className="flex items-center gap-2">
            <svg
              ...
              height="15"
              viewBox="0 0 20 20"
              className=" dark:stroke-black dark:fill-white fill-white stroke-black"
              fill="none"
          ...
          <div className="ml-auto relative rounded-full w-7 h-7 flex items-center justify-center border dark:border-white/30 border-black/15">
            <svg
              width="15"
              height="15"
              viewBox="0 0 20 20"
            ...
            <div className="absolute right-0 bg-red-500 animate-pulse rounded-full w-2 h-2 top-0" />
          </div>
        </div>
